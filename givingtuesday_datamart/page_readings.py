...
verdicts (``page_verdicts``, ``agree``) are the next session's. The
...
def main() -> None:
    ...
    read.add_argument("--workers", type=int, required=True, help="Qwen 40, Flash Lite 12, 3.8 Flash and Sonnet 8")
