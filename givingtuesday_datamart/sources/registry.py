...
REGISTRY: tuple[SourceSpec, ...] = (
    _spec(
        ...
        staging_table_name="irs_filings.basic_fields",
        form_type="990",
    ...
    _spec(
        ...
        staging_table_name="irs_filings.basic_fields_pf",
        form_type="990-PF",
    ...
    _spec(
        ...
        staging_table_name="irs_filings.mission_statements",
        form_type="990",
    ...
    _spec(
        ...
        staging_table_name="irs_filings.programs",
        form_type="990",
    ...
    _spec(
        ...
        staging_table_name="irs_filings.schedule_o",
        form_type="990",
    ...
    _spec(
        ...
        staging_table_name="irs_filings.grants_to_domestic_organizations",
        form_type="990",
    ...
    _spec(
        ...
        staging_table_name="irs_filings.privategrants",
        form_type="990-PF",
    ...
    _spec(
        ...
        staging_table_name="irs_filings.officers",
        form_type="990",
    ...
    _spec(
        ...
        staging_table_name="irs_filings.officers_pf",
        form_type="990-PF",
